...
class ProductCard extends ConsumerWidget {
  ...
  String? get _badgeLabel {
    final category = rawProduct?.category?.category ??
        rawProduct?.category?.subcategory;
  ...
  String? get _shopName {
    ...
    final partner = rawProduct?.partnerObj ??
    ...
    if (partner != null) {
      ...
      final fromPartner = (partner['shopName'] ??
    ...
    return InteractiveFeedbackButton(
      onPressed: () {
        final Map<String, dynamic> productData =
            Map<String, dynamic>.from(rawProduct?.toJson() ?? {
          'name': productName,
          'image': imageUrl,
          'price': price ?? '',
